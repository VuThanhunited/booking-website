      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelAddress">
            ...
            <span className="hotelShowMap"> - {t("showMap")}</span>
          </div>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              <h1 className="hotelTitle">
                {lang === "vi" ? `Lưu trú tại ${hotel.name}` : `Stay at ${hotel.name}`}
              </h1>
              <p className="hotelDesc">{hotel.description}</p>
            </div>
            <div className="hotelDetailsPrice">
              <h1>{lang === "vi" ? "Chỗ nghỉ hoàn hảo!" : "Perfect for a stay!"}</h1>
              <span>{hotel.locationHighlight}</span>
              <h2>
                <b>${hotel.cheapestPrice}</b> ({lang === "vi" ? "1 đêm" : "1 night"})
              </h2>
              <button
                className="bookNow"
                onClick={() => setShowBookingForm(!showBookingForm)}
